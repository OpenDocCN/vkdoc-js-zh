...
![img/512020_1_En_5_Chapter/512020_1_En_5_Fig1_HTML.jpg](img/512020_1_En_5_Fig1_HTML.jpg)
...
由于前端站点是通过 Firebase 托管的，所以可以在 create-react-app 创建 React app 的同时创建基本设置。按照第一章的设置说明，我在 Firebase 控制台中创建了**图片社交网**。

由于使用了认证功能，您需要进行第四章中提到的额外配置，并使用您需要复制的`firebaseConfig`(参见图 5-2 )。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig2_HTML.jpg](img/512020_1_En_5_Fig2_HTML.jpg)
...
在`index.js`、`App.js`和`App.css`中删除文件和基本设置就像在第二章中所做的一样。遵循这些指示。图 5-3 显示了应用在 localhost 上的外观。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig3_HTML.jpg](img/512020_1_En_5_Fig3_HTML.jpg)
...
![img/512020_1_En_5_Chapter/512020_1_En_5_Fig4_HTML.jpg](img/512020_1_En_5_Fig4_HTML.jpg)
...
![img/512020_1_En_5_Chapter/512020_1_En_5_Fig5_HTML.jpg](img/512020_1_En_5_Fig5_HTML.jpg)
...
![img/512020_1_En_5_Chapter/512020_1_En_5_Fig6_HTML.jpg](img/512020_1_En_5_Fig6_HTML.jpg)
...
你需要回到火焰基地。点击**认证**选项卡，然后点击**开始**按钮，如图 5-7 所示。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig7_HTML.jpg](img/512020_1_En_5_Fig7_HTML.jpg)

图 5-7

开始

在下一个界面中，点击**邮箱/密码**的编辑图标，如图 5-8 所示。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig8_HTML.jpg](img/512020_1_En_5_Fig8_HTML.jpg)

图 5-8

电子邮件和密码

在弹出的窗口中，点击**启用**按钮，然后点击**保存**按钮，如图 5-9 所示。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig9_HTML.jpg](img/512020_1_En_5_Fig9_HTML.jpg)
...
在 localhost 上，点击**注册**按钮，获得带文本的模态(见图 5-10 )。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig10_HTML.jpg](img/512020_1_En_5_Fig10_HTML.jpg)
...
图 5-11 显示点击 localhost 上的**注册**按钮打开一个表单。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig11_HTML.jpg](img/512020_1_En_5_Fig11_HTML.jpg)
...
![img/512020_1_En_5_Chapter/512020_1_En_5_Fig12_HTML.jpg](img/512020_1_En_5_Fig12_HTML.jpg)
...
localhost 上的按钮有了新的**标志。它会打开一个弹出窗口来输入凭证(参见图 5-13 )。使用您为登录按钮输入的相同凭据，您可以成功登录。**

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig13_HTML.jpg](img/512020_1_En_5_Fig13_HTML.jpg)
...
![img/512020_1_En_5_Chapter/512020_1_En_5_Fig14_HTML.jpg](img/512020_1_En_5_Fig14_HTML.jpg)
...
![img/512020_1_En_5_Chapter/512020_1_En_5_Fig15_HTML.jpg](img/512020_1_En_5_Fig15_HTML.jpg)
...
接下来，通过在终端中输入`npm init`命令来创建`package.json`文件。你被问了一堆问题；对于大多数情况，只需按下回车键。你可以提供**描述**和**作者**，但不是强制的。通常在标准的`server.js,`处设置进入点(见图 5-16 )。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig16_HTML.jpg](img/512020_1_En_5_Fig16_HTML.jpg)
...
在终端输入 **nodemon server.js** 查看**监听 localhost: 9000** 控制台日志。为了检查路线是否正常工作，转到`http://localhost:9000/`查看终点文本，如图 5-17 所示。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig17_HTML.jpg](img/512020_1_En_5_Fig17_HTML.jpg)
...
之后，点击**正文**然后选择 **raw** 。从下拉菜单切换到 **JSON(应用/json)** 。在文本编辑器中，输入如图 5-18 所示的数据。要改变的一件事是通过给键加上双引号来使数据 JSON。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig18_HTML.jpg](img/512020_1_En_5_Fig18_HTML.jpg)

图 5-18

邮递员邮件

接下来，点击**发送**按钮。如果一切正确，你得到**状态:201 已创建**，如图 5-18 所示。

我以类似的方式插入了其他数据。您需要测试 GET `/sync`端点。将请求更改为 GET，然后单击**发送**按钮。如果一切正确，你得到**状态:200 OK** ，如图 5-19 所示。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig19_HTML.jpg](img/512020_1_En_5_Fig19_HTML.jpg)
...
如果您遇到此错误，请转到您的**网络访问**选项卡，并点击**添加 IP 地址**按钮。之后点击**添加当前 IP 地址**按钮，点击**确认**，如图 5-20 所示。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig20_HTML.jpg](img/512020_1_En_5_Fig20_HTML.jpg)
...
在测试之前，您需要在 Firebase 控制台中设置存储。首先点击**存储**选项卡，然后点击**开始**按钮，弹出如图 5-21 所示的窗口。然后，点击**下一个**按钮。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig21_HTML.jpg](img/512020_1_En_5_Fig21_HTML.jpg)

图 5-21

燃料库

在下一个画面中，点击**完成**按钮，如图 5-22 所示。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig22_HTML.jpg](img/512020_1_En_5_Fig22_HTML.jpg)

图 5-22

云存储

进入本地主机，上传任何图片，输入标题，点击**上传**按钮。你可以看到帖子被保存到 MongoDB(见图 5-23 )。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig23_HTML.jpg](img/512020_1_En_5_Fig23_HTML.jpg)
...
![img/512020_1_En_5_Chapter/512020_1_En_5_Fig24_HTML.jpg](img/512020_1_En_5_Fig24_HTML.jpg)
...
![img/512020_1_En_5_Chapter/512020_1_En_5_Fig25_HTML.jpg](img/512020_1_En_5_Fig25_HTML.jpg)
...
转到 [`www.heroku.com`](http://www.heroku.com) 部署后端。按照第一章的步骤创建一个名为**照片-社交-后台**的应用。

由于这次您有环境变量，您必须将它们添加到**设置➤配置变量**中。请注意，不要在按键周围加上任何引号，如图 5-26 所示。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig26_HTML.jpg](img/512020_1_En_5_Fig26_HTML.jpg)

图 5-26

Heroku 的环境变量

部署成功后，进入 [`https://photo-social-backend.herokuapp.com`](https://photo-social-backend.herokuapp.com) 。图 5-27 显示了正确的文本。

![img/512020_1_En_5_Chapter/512020_1_En_5_Fig27_HTML.jpg](img/512020_1_En_5_Fig27_HTML.jpg)
...
![img/512020_1_En_5_Chapter/512020_1_En_5_Fig28_HTML.jpg](img/512020_1_En_5_Fig28_HTML.jpg)
