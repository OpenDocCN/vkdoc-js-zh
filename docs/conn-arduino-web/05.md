...
![A453258_1_En_5_Fig1_HTML.jpg](A453258_1_En_5_Fig1_HTML.jpg)
...
![A453258_1_En_5_Fig2_HTML.jpg](A453258_1_En_5_Fig2_HTML.jpg)
...
安装模块时会自动创建节点模块文件夹。创建服务器的设置与第 [3](03.html) 章相同:
...
有两个变量保存对页面上颜色块元素的引用，“redBlock”和“greenBlock”事件侦听器被添加到这些变量中。JavaScript 事件监听器总是监听特定事件的发生。当它发生时，它可以调用一个函数。在这种情况下，该函数改变块的颜色。它通过添加或删除一个名为“红块开”或“绿块开”的类来实现这一点添加或移除类来更改元素是常见的做法。这意味着改变的所有 CSS 都在一个地方。表 [5-3](#Tab3) 解释 main.js。
...
最后更新清单 [5-1](#Par15) 中的 index.js 文件。更新以粗体显示。
...
![A453258_1_En_5_Fig3_HTML.jpg](A453258_1_En_5_Fig3_HTML.jpg)
...
![A453258_1_En_5_Fig4_HTML.jpg](A453258_1_En_5_Fig4_HTML.jpg)
...
![A453258_1_En_5_Fig5_HTML.jpg](A453258_1_En_5_Fig5_HTML.jpg)
...
![A453258_1_En_5_Fig6_HTML.jpg](A453258_1_En_5_Fig6_HTML.jpg)
