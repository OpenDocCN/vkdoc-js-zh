...
![Image](../Images/image00500.jpeg) **注意**html 5 规范还包括一个游戏手柄 API，可以让你捕捉游戏控制器按钮的输入。查看`dvcs.w3.org`处的规格。它像键盘、鼠标和触摸事件一样易于使用。
...
![Image](../Images/image00500.jpeg) **注意**注意如何使用`bind`方法将监听器连接到`space.downHandler`和`space.upHandler`方法。它确保在空间对象中引用“this”是指空间对象本身，而不是窗口对象。
...
![9781430258001_Fig06-01.jpg](../Images/image00559.jpeg)
...
![9781430258001_Fig06-02.jpg](../Images/image00560.jpeg)
...
![Image](../Images/image00500.jpeg) **注意**这个例子也展示了你需要编写的最少的 HTML5 代码，并且仍然有一个有效的 HTML 文档。短小精悍！`<html>`和`<body>`标签是可选的。您可能仍然需要一个`<body>`标签作为添加和删除 HTML 元素的钩子，但是如果您忽略它，HTML5 规范会认为它是隐含的。
...
![9781430258001_Fig06-03.jpg](../Images/image00561.jpeg)
...
![9781430258001_Fig06-04.jpg](../Images/image00562.jpeg)
...
![9781430258001_Fig06-05.jpg](../Images/image00563.jpeg)
...
![9781430258001_Fig06-06.jpg](../Images/image00564.jpeg)
...
![9781430258001_Fig06-07.jpg](../Images/image00565.jpeg)
...
![9781430258001_Fig06-08.jpg](../Images/image00566.jpeg)
...
![9781430258001_Fig06-09.jpg](../Images/image00567.jpeg)
...
![9781430258001_Fig06-10.jpg](../Images/image00568.jpeg)
...
![9781430258001_Fig06-11.jpg](../Images/image00569.jpeg)
...
![9781430258001_Fig06-12.jpg](../Images/image00570.jpeg)
...
![9781430258001_Fig06-13.jpg](../Images/image00571.jpeg)

[图 6-13](#_Fig13) 。将按钮图像状态添加到纹理贴图集

![Image](../Images/image00500.jpeg) **注意**虽然有三种图像状态是标准的，但有时候按钮只有两种图像状态。这对于只有触摸的按钮来说尤其如此，因为它们没有“结束”状态。我们将在前面创建的按钮 sprite 将使用三个图像(如果它们可用的话),但是如果它只有两个图像，代码将假定它们指的是“向上”和“向下”状态。

接下来，将纹理地图加载到游戏程序中:

```
assets.load(["images/button.json"]).then(() => setup());
```
...
![9781430258001_Fig06-14.jpg](../Images/image00572.jpeg)
...
![Image](../Images/image00500.jpeg) **注意**你也可以让`stage`对象交互。如果您想知道玩家是否点击或按下了画布，这将非常有用。

运行`interacteractiveSprites.html`演示该功能，如图[图 6-15](#Fig15) 所示。如果你点击这个圆，它的填充和描边颜色会随机改变。

![9781430258001_Fig06-15.jpg](../Images/image00573.jpeg)
...
![Image](../Images/image00500.jpeg) **注意**记住如果你设置一个 sprite 的交互属性为`true`，你还需要导入`buttons`数组，更新游戏循环中的所有按钮。
...
![9781430258001_Fig06-16.jpg](../Images/image00574.jpeg)
