...
![image](img/sq.jpg) **注**关于球体和立方体几何图形的复习，请参考[`en.wikipedia.org/wiki/Sphere`](http://en.wikipedia.org/wiki/Sphere)和[`en.wikipedia.org/wiki/Cube`](http://en.wikipedia.org/wiki/Cube)
