...
*   ![$$ {p}_{new} = {p}_{current} + displacement $$](Images/A432927_1_En_4_Chapter_Equa.gif)

![A432927_1_En_4_Fig1_HTML.gif](Images/A432927_1_En_4_Fig1_HTML.gif)

###### 图 4-1。基于恒定位移的运动

当需要随时间改变位移量时，由恒定位移公式控制的运动变得受限。牛顿力学通过在运动公式中考虑时间来解决这一限制，如下面的方程所示。

*   ![$$ {v}_{new}={v}_{current}+{\displaystyle \int } a(t) d t $$](Images/A432927_1_En_4_Chapter_Equb.gif)

*   ![$$ {p}_{new} = {p}_{current}+{\displaystyle \int } v(t) d t $$](Images/A432927_1_En_4_Chapter_Equc.gif)
...
*   ![$$ {v}_{new}={v}_{current} + {a}_{current}* d t $$](Images/A432927_1_En_4_Chapter_Equd.gif)

*   ![$$ {p}_{new} = {p}_{current} + {v}_{current}* d t $$](Images/A432927_1_En_4_Chapter_Eque.gif)
...
![A432927_1_En_4_Fig2_HTML.jpg](Images/A432927_1_En_4_Fig2_HTML.jpg)
...
*   ![$$ {v}_{new}={v}_{current} + {a}_{current}* d t $$](Images/A432927_1_En_4_Chapter_Equf.gif)

*   ![$$ {p}_{new} = {p}_{current} + {v}_{new}* d t $$](Images/A432927_1_En_4_Chapter_Equg.gif)
...
![A432927_1_En_4_Fig3_HTML.gif](Images/A432927_1_En_4_Fig3_HTML.gif)
...
![A432927_1_En_4_Fig4_HTML.gif](Images/A432927_1_En_4_Fig4_HTML.gif)
...
图 [4-5](#Fig5) 显示了三个不同阶段的圆 A。在第一阶段，圆圈以速度![$$ {\overrightarrow{V}}_1 $$](Images/A432927_1_En_4_Chapter_IEq1.gif)向右边的墙移动。在第二阶段，圆圈与墙壁相撞。在阶段 3，圆被反射并以速度![$$ {\overrightarrow{V}}_2 $$](Images/A432927_1_En_4_Chapter_IEq2.gif)离开墙壁。

![A432927_1_En_4_Fig5_HTML.jpg](Images/A432927_1_En_4_Fig5_HTML.jpg)

###### 图 4-5。完美世界中圆与墙的碰撞

从数学上讲，这种碰撞及其响应可以通过将初始速度![$$ {\overrightarrow{V}}_1 $$](Images/A432927_1_En_4_Chapter_IEq3.gif)分解成平行于或相切于碰撞壁的分量![$$ \hat{T} $$](Images/A432927_1_En_4_Chapter_IEq4.gif)，以及垂直于或正交于碰撞壁的分量![$$ \hat{N} $$](Images/A432927_1_En_4_Chapter_IEq5.gif)来描述。如下面的等式所示。

*   ![$$ {\overrightarrow{V}}_1=\left({\overrightarrow{V}}_1\cdot \hat{N}\right)\hat{N}+\left({\overrightarrow{V}}_1\cdot \hat{T}\right)\hat{T} $$](Images/A432927_1_En_4_Chapter_Equh.gif)

在没有摩擦和动能损失的完美世界中，碰撞后，沿切线方向的分量不受影响，而法向分量将简单地反转。这样，反射向量![$$ {\overrightarrow{V}}_2 $$](Images/A432927_1_En_4_Chapter_IEq6.gif)可以表示为![$$ {\overrightarrow{V}}_1 $$](Images/A432927_1_En_4_Chapter_IEq7.gif)的法向分量和切向分量的线性组合，如下所示。

*   ![$$ {\overrightarrow{V}}_2=-\left({\overrightarrow{V}}_1\cdot \hat{N}\right)\hat{N}+\left({\overrightarrow{V}}_1\cdot \hat{T}\right)\hat{T} $$](Images/A432927_1_En_4_Chapter_Equi.gif)

注意![$$ \hat{N} $$](Images/A432927_1_En_4_Chapter_IEq8.gif)组件前面的负号。你可以在图 [4-5](#Fig5) 中看到，由于碰撞，矢量![$$ {\overrightarrow{V}}_2 $$](Images/A432927_1_En_4_Chapter_IEq10.gif)的![$$ \hat{N} $$](Images/A432927_1_En_4_Chapter_IEq9.gif)分量指向与![$$ {\overrightarrow{V}}_1 $$](Images/A432927_1_En_4_Chapter_IEq11.gif)相反的方向。还要注意，切线分量![$$ \hat{T} $$](Images/A432927_1_En_4_Chapter_IEq12.gif)仍然指向相同的方向，因为它平行于墙的方向，并且不受碰撞的影响。这演示了一个矢量反射。

#### 碰撞形状的相对速度

这种将向量分解为碰撞的法线方向和切线方向的方法也适用于碰撞形状都在运动的一般情况。例如，图 [4-6](#Fig6) 显示了两个行进的圆形 A 和 B 发生碰撞。

![A432927_1_En_4_Fig6_HTML.jpg](Images/A432927_1_En_4_Fig6_HTML.jpg)

###### 图 4-6。两个圆之间的碰撞

在图 [4-6](#Fig6) 的情况下，在碰撞之前，形状 A 以速度![$$ {\overrightarrow{V}}_{A1} $$](Images/A432927_1_En_4_Chapter_IEq13.gif)行进，而形状 B 以速度![$$ {\overrightarrow{V}}_{B1} $$](Images/A432927_1_En_4_Chapter_IEq14.gif)行进。碰撞的法线方向![$$ \hat{N} $$](Images/A432927_1_En_4_Chapter_IEq15.gif)被定义为两个圆心之间的矢量，而碰撞的切线方向![$$ \hat{T} $$](Images/A432927_1_En_4_Chapter_IEq16.gif)是在碰撞点与两个圆相切的矢量。为了解决这种碰撞，必须计算碰撞后形状 A 和 B 的速度![$$ {\overrightarrow{V}}_{A2} $$](Images/A432927_1_En_4_Chapter_IEq17.gif)和![$$ {\overrightarrow{V}}_{B2} $$](Images/A432927_1_En_4_Chapter_IEq18.gif)。

形状 A 和 B 之间的相对速度定义如下。

*   ![$$ {\overrightarrow{V}}_{A B1}={\overrightarrow{V}}_{A1}-{\overrightarrow{V}}_{B1} $$](Images/A432927_1_En_4_Chapter_Equj.gif)

碰撞矢量分解现在可以应用于相对速度的法线方向，其中碰撞后的相对速度为![$$ {\overrightarrow{V}}_{AB2} $$](Images/A432927_1_En_4_Chapter_IEq19.gif)。

*   ![$$ {\overrightarrow{V}}_{AB2}\cdot \hat{N}=- e\left({\overrightarrow{V}}_{AB1}\cdot \hat{N}\right)\hat{N} $$](Images/A432927_1_En_4_Chapter_Equ1.gif)①

恢复系数 *e* 模拟了真实世界的情况，即在碰撞过程中，一些动能转变为其他形式的能量。请注意，等式右侧的所有变量( [1](#Equ1) )都已定义，因为它们在碰撞时是已知的，并且形状 A 和 B 碰撞后相对速度的法向分量![$$ {\overrightarrow{V}}_{AB2} $$](Images/A432927_1_En_4_Chapter_IEq20.gif)也已定义。重要的是要记住，

*   ![$$ {\overrightarrow{V}}_{A B2}={\overrightarrow{V}}_{A2}-{\overrightarrow{V}}_{B2} $$](Images/A432927_1_En_4_Chapter_IEq21.gif)。

你现在已经准备好估算![$$ {\overrightarrow{V}}_{A2} $$](Images/A432927_1_En_4_Chapter_IEq22.gif)和![$$ {\overrightarrow{V}}_{B2} $$](Images/A432927_1_En_4_Chapter_IEq23.gif)，碰撞后碰撞形状的速度。

#### 近似脉冲响应

准确描述碰撞涉及复杂的考虑因素，包括能量变化形式或不同材料特性产生的摩擦等因素。如果不考虑这些高级问题，对发生在一个形状上的碰撞的简单描述是，一个恒定质量的物体在与另一个物体接触后，其速度从![$$ {\overrightarrow{V}}_{A1} $$](Images/A432927_1_En_4_Chapter_IEq24.gif)变为![$$ {\overrightarrow{V}}_{A2} $$](Images/A432927_1_En_4_Chapter_IEq25.gif)。方便的是，这就是脉冲的定义，如下所示。

*   ![$$ j={m}_A{\overrightarrow{V}}_{A2} - {m}_A{\overrightarrow{V}}_{A1} $$](Images/A432927_1_En_4_Chapter_Equk.gif)

或者，在求解![$$ {\overrightarrow{V}}_{A2} $$](Images/A432927_1_En_4_Chapter_IEq26.gif)时，

*   ![$$ {\overrightarrow{V}}_{A2}={\overrightarrow{V}}_{A1} + \frac{j}{m_A} $$](Images/A432927_1_En_4_Chapter_Equl.gif)

从数学上退一步，想想这个公式说明了什么。直觉上讲得通。它指出速度的变化与形状的质量成反比。换句话说，一个形状的质量越大，碰撞后它的速度变化就越小。冲量法实现了这种观察，对于法向分量，它定义了形状 A 和 B 碰撞后的速度，![$$ {\overrightarrow{V}}_{A2} $$](Images/A432927_1_En_4_Chapter_IEq27.gif)和![$$ {\overrightarrow{V}}_{B2} $$](Images/A432927_1_En_4_Chapter_IEq28.gif)，如下所示。在这种情况下，*m*<sub xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" class="calibre29">T5】A</sub>， *m* <sub xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" class="calibre29">* B *</sub> 是形状 A 和 B 的质量

*   ![$$ {\overrightarrow{V}}_{A2}\cdot \hat{N}={\overrightarrow{V}}_{A1}\cdot \hat{N}+\frac{j_N}{m_A} $$](Images/A432927_1_En_4_Chapter_Equm.gif)

*   ![$$ {\overrightarrow{V}}_{B2}\cdot \hat{N}={\overrightarrow{V}}_{B1}\cdot \hat{N}-\frac{j_N}{m_B} $$](Images/A432927_1_En_4_Chapter_Equn.gif)

减去上述两个方程计算出相对速度的法向分量。

*   ![$$ \left({\overrightarrow{V}}_{A2}-{\overrightarrow{V}}_{\mathrm{B}2}\right)\cdot \hat{N}=\left({\overrightarrow{V}}_{A1}-{\overrightarrow{V}}_{B1}\right)\cdot \hat{N}+{j}_N\left(\frac{1}{m_A}+\frac{1}{m_B}\right) $$](Images/A432927_1_En_4_Chapter_Equo.gif)

回想一下，![$$ \left({\overrightarrow{V}}_{A2}-{\overrightarrow{V}}_{B2}\right) $$](Images/A432927_1_En_4_Chapter_IEq29.gif)就是简单的![$$ {\overrightarrow{V}}_{AB2} $$](Images/A432927_1_En_4_Chapter_IEq30.gif)，而![$$ \left({\overrightarrow{V}}_{A1}-{\overrightarrow{V}}_{B1}\right) $$](Images/A432927_1_En_4_Chapter_IEq31.gif)就是![$$ {\overrightarrow{V}}_{AB1} $$](Images/A432927_1_En_4_Chapter_IEq32.gif)，这个等式简化为如下。

*   ![$$ {\overrightarrow{V}}_{A B2}\cdot \hat{N}={\overrightarrow{V}}_{A B1}\cdot \hat{N}+{j}_N\left(\frac{1}{m_A}+\frac{1}{m_B}\right) $$](Images/A432927_1_En_4_Chapter_Equp.gif)

将等式( [1](#Equ1) )代入左侧，可导出以下等式。

*   ![$$ - e\left({\overrightarrow{V}}_{A B1}\cdot \hat{N}\right)={\overrightarrow{V}}_{A B1}\cdot \hat{N}+{j}_N\left(\frac{1}{m_A}+\frac{1}{m_B}\right) $$](Images/A432927_1_En_4_Chapter_Equq.gif)

收集项，求解公式为 *j* <sub class="calibre29">*N*</sub> ，法线方向的冲量，给你以下。

*   ![$$ {j}_N=\frac{-\left(1+ e\right)\left({\overrightarrow{V}}_{A B1}\cdot \hat{N}\right)}{\frac{1}{m_A}+\frac{1}{m_B}} $$](Images/A432927_1_En_4_Chapter_Equ2.gif) (2g)

最后，切线方向上的冲量， *j* <sub class="calibre29">*T*</sub> ，可以以类似的方式导出下面的结果。

*   ![$$ {j}_T=\frac{-\left(1+ e\right)\left({\overrightarrow{V}}_{A B1}\cdot \hat{T}\right) f\ }{\frac{1}{m_A}+\frac{1}{m_B}} $$](Images/A432927_1_En_4_Chapter_Equ3.gif) (3)
...
![A432927_1_En_4_Fig7_HTML.jpg](Images/A432927_1_En_4_Fig7_HTML.jpg)
...
![A432927_1_En_4_Fig8_HTML.gif](Images/A432927_1_En_4_Fig8_HTML.gif)
...
将旋转整合到脉冲方法公式中的关键是认识到这样一个事实，即你一直在处理的线速度，例如形状 A 的速度![$$ {\overrightarrow{V}}_{A1} $$](Images/A432927_1_En_4_Chapter_IEq33.gif)，实际上是该形状在其中心位置的速度。在没有旋转的情况下，该速度在整个形状中是恒定的，并且可以应用于任何位置。然而，如图 [4-9](#Fig9) 所示，当一个形状的运动包含角速度![$$ {\overrightarrow{\omega}}_{A1} $$](Images/A432927_1_En_4_Chapter_IEq34.gif)时，其在位置 *P* 、![$$ {\overrightarrow{V}}_{AP1} $$](Images/A432927_1_En_4_Chapter_IEq35.gif)处的线速度，实际上是该点与该形状旋转中心![$$ {\overrightarrow{R}}_{AP} $$](Images/A432927_1_En_4_Chapter_IEq36.gif)的相对位置的函数。

*   ![$$ {\overrightarrow{V}}_{A P1}={\overrightarrow{V}}_{A1}+\left({\overrightarrow{\omega}}_{A1}\times {\overrightarrow{R}}_{A P}\right) $$](Images/A432927_1_En_4_Chapter_Equr.gif)

![A432927_1_En_4_Fig9_HTML.jpg](Images/A432927_1_En_4_Fig9_HTML.jpg)

###### 图 4-9。*存在旋转时某一位置的线速度*

###### 注意

角速度是一个垂直于线速度的矢量。在这种情况下，由于线速度是在 X/Y 平面上定义的，![$$ \overrightarrow{\omega} $$](Images/A432927_1_En_4_Chapter_IEq37.gif)是 z 方向上的矢量，因为物体围绕其质心旋转。为了简单起见，在您的实现中，![$$ \overrightarrow{\omega} $$](Images/A432927_1_En_4_Chapter_IEq38.gif)将被存储为一个简单的标量，表示矢量的 z 分量幅度。

### 用旋转表述冲量法

类似于线性脉冲响应的情况，碰撞后角速度的变化与转动惯量成反比也是事实。如图 [4-10](#Fig10) 所示，对于转动惯量为*I*<sub xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" class="calibre29">T5】A</sub>和 *I* <sub xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" class="calibre29">*B*</sub> 的形状 A 和 B；以及![$$ {\overrightarrow{\omega}}_{A1} $$](Images/A432927_1_En_4_Chapter_IEq39.gif)和![$$ {\overrightarrow{\omega}}_{B1} $$](Images/A432927_1_En_4_Chapter_IEq40.gif)的初始角速度；碰撞后，角速度![$$ {\overrightarrow{\omega}}_{A2} $$](Images/A432927_1_En_4_Chapter_IEq41.gif)和![$$ {\overrightarrow{\omega}}_{B2} $$](Images/A432927_1_En_4_Chapter_IEq42.gif)定义如下。

*   ![$$ {\overrightarrow{\omega}}_{A2}={\overrightarrow{\omega}}_{A1}+\left({\overrightarrow{R}}_{A P}\times \hat{N}\right)\frac{j}{I_A} $$](Images/A432927_1_En_4_Chapter_Equs.gif)

*   ![$$ {\overrightarrow{\omega}}_{B2}={\overrightarrow{\omega}}_{B1}-\left({\overrightarrow{R}}_{B P}\times \hat{N}\right)\frac{j}{I_B} $$](Images/A432927_1_En_4_Chapter_Equt.gif)

其中![$$ {\overrightarrow{R}}_{AP} $$](Images/A432927_1_En_4_Chapter_IEq43.gif)和![$$ {\overrightarrow{R}}_{BP} $$](Images/A432927_1_En_4_Chapter_IEq44.gif)是从每个形状的旋转中心到碰撞点的位置向量，*P*；![$$ \hat{N} $$](Images/A432927_1_En_4_Chapter_IEq45.gif)和是碰撞的法线和切线。

![A432927_1_En_4_Fig10_HTML.jpg](Images/A432927_1_En_4_Fig10_HTML.jpg)

###### 图 4-10。*两个碰撞形状的角速度*

回想一下，冲量法公式是基于将碰撞后的相对速度![$$ {\overrightarrow{V}}_{A B2}={\overrightarrow{V}}_{A2}-{\overrightarrow{V}}_{B2} $$](Images/A432927_1_En_4_Chapter_IEq46.gif)分解为法线方向和切线方向而得出的。![$$ {\overrightarrow{V}}_{A B1}={\overrightarrow{V}}_{A1}-{\overrightarrow{V}}_{B1} $$](Images/A432927_1_En_4_Chapter_IEq47.gif)是碰撞前的相对速度，上一节的方程式( [1](#Equ1) 重复如下。

*   ![$$ {\overrightarrow{V}}_{AB2}\cdot \hat{N}=- e\left({\overrightarrow{V}}_{AB1}\cdot \hat{N}\right)\hat{N} $$](Images/A432927_1_En_4_Chapter_Equu.gif)

注意，这个方程是在考虑旋转之前导出的，公式假设每个形状的速度在整个形状上是恒定的。为了支持旋转，这个方程必须推广，在碰撞点求解， *P* 。

*   ![$$ {\overrightarrow{V}}_{ABP2}\cdot \hat{N}=- e\left({\overrightarrow{V}}_{ABP1}\cdot \hat{N}\right)\hat{N} $$](Images/A432927_1_En_4_Chapter_Equ4.gif) (4)

在这种情况下，![$$ {\overrightarrow{V}}_{ABP1} $$](Images/A432927_1_En_4_Chapter_IEq48.gif)和![$$ {\overrightarrow{V}}_{ABP2} $$](Images/A432927_1_En_4_Chapter_IEq49.gif)是碰撞位置 *P* 处的相对速度，在碰撞之前和之后，以下对于这些矢量仍然成立。

*   ![$$ {\overrightarrow{V}}_{ABP1}={\overrightarrow{V}}_{AP1}-{\overrightarrow{V}}_{BP1} $$](Images/A432927_1_En_4_Chapter_Equv.gif)

*   ![$$ {\overrightarrow{V}}_{ABP2}={\overrightarrow{V}}_{AP2}-{\overrightarrow{V}}_{BP2} $$](Images/A432927_1_En_4_Chapter_Equw.gif)

如前所述，现在可以将下列方程和相对矢量的定义一起代入方程( [4](#Equ4) )并求解脉冲 *j* 。

*   ![$$ {\overrightarrow{V}}_{A P1}={\overrightarrow{V}}_{A1}+\left({\overrightarrow{\omega}}_{A1}\times {\overrightarrow{R}}_{A P}\right) $$](Images/A432927_1_En_4_Chapter_Equx.gif)

*   ![$$ {\overrightarrow{V}}_{B P1}={\overrightarrow{V}}_{B1}+\left({\overrightarrow{\omega}}_{B1}\times {\overrightarrow{R}}_{B P}\right) $$](Images/A432927_1_En_4_Chapter_Equy.gif)

*   ![$$ {\overrightarrow{V}}_{A P2}\cdot \hat{N}={\overrightarrow{V}}_{A P1}\cdot \hat{N}+\frac{j}{m_A} $$](Images/A432927_1_En_4_Chapter_Equz.gif)

*   ![$$ {\overrightarrow{V}}_{B P2}\cdot \hat{N}={\overrightarrow{V}}_{B P1}\cdot \hat{N}-\frac{j}{m_B} $$](Images/A432927_1_En_4_Chapter_Equaa.gif)

*   ![$$ {\overrightarrow{\omega}}_{A2}={\overrightarrow{\omega}}_{A1}+\left({\overrightarrow{R}}_{A P}\times \hat{N}\right)\frac{j}{I_A} $$](Images/A432927_1_En_4_Chapter_Equab.gif)

*   ![$$ {\overrightarrow{\omega}}_{B2}={\overrightarrow{\omega}}_{B1}-\left({\overrightarrow{R}}_{B P}\times \hat{N}\right)\frac{j}{I_B} $$](Images/A432927_1_En_4_Chapter_Equac.gif)

虽然繁琐，但简化代数相对直接，由此产生的碰撞法向冲量， *j* <sub class="calibre29">*N*</sub> ，可表示如下。

*   ![$$ {j}_N=\frac{-\left(1+ e\right)\left({\overrightarrow{V}}_{A B1}\cdot \hat{N}\right)}{\frac{1}{m_A}+\frac{1}{m_B}+\frac{{\left({\overrightarrow{R}}_{A P}\times \hat{N}\right)}^2}{I_A}+\frac{{\left({\overrightarrow{R}}_{B P}\times \hat{N}\right)}^2}{I_B}} $$](Images/A432927_1_En_4_Chapter_Equ5.gif) (5)

类似于线性响应的情况，切线方向上的脉冲 *j* <sub class="calibre29">*T*</sub> ，可以推导并表示如下。

*   ![$$ {j}_T=\frac{-\left(1+ e\right)\left({\overrightarrow{V}}_{A B1}\cdot \hat{T}\right) f}{\frac{1}{m_A}+\frac{1}{m_B}+\frac{{\left({\overrightarrow{R}}_{A P}\times \hat{T}\right)}^2}{I_A}+\frac{{\left({\overrightarrow{R}}_{B P}\times \hat{T}\right)}^2}{I_B}} $$](Images/A432927_1_En_4_Chapter_Equ6.gif) (6)

同样，摩擦系数， *f* ，是一个简单的摩擦近似值。此外，请注意，由于![$$ {\overrightarrow{R}}_{AP} $$](Images/A432927_1_En_4_Chapter_IEq50.gif)和![$$ \hat{N} $$](Images/A432927_1_En_4_Chapter_IEq51.gif)是 X/Y 平面中的向量，因此在实现中![$$ {\overrightarrow{R}}_{AP}\times \hat{N} $$](Images/A432927_1_En_4_Chapter_IEq52.gif)是代表结果向量的 z 分量幅度的标量。
...
![A432927_1_En_4_Fig11_HTML.gif](Images/A432927_1_En_4_Fig11_HTML.gif)
...
2.  计算碰撞位置![$$ {\overrightarrow{V}}_{AP1} $$](Images/A432927_1_En_4_Chapter_IEq53.gif)和![$$ {\overrightarrow{V}}_{BP1} $$](Images/A432927_1_En_4_Chapter_IEq54.gif)的速度很重要。在下面，r1 和 r2 是形状 A 和 b 的![$$ {\overrightarrow{R}}_{AP} $$](Images/A432927_1_En_4_Chapter_IEq55.gif)和![$$ {\overrightarrow{R}}_{AP} $$](Images/A432927_1_En_4_Chapter_IEq56.gif)位置向量。注意，在实现中，碰撞位置 *P* 只是碰撞信息中的 mStart 位置。变量 v1 和 v2 是实际的![$$ {\overrightarrow{V}}_{AP1} $$](Images/A432927_1_En_4_Chapter_IEq57.gif)和![$$ {\overrightarrow{V}}_{BP1} $$](Images/A432927_1_En_4_Chapter_IEq58.gif)向量。
