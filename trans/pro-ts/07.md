...
![A323824_2_En_7_Fig1_HTML.jpg](A323824_2_En_7_Fig1_HTML.jpg)
...
您可以使用 NPM 来处理生产和开发依赖性。生产依赖项是应用程序运行时必须存在的模块。开发依赖项包括工具和类型定义，它们只在编码时需要，在运行应用程序时不需要。
...
![A323824_2_En_7_Fig2_HTML.jpg](A323824_2_En_7_Fig2_HTML.jpg)
...
![A323824_2_En_7_Fig3_HTML.jpg](A323824_2_En_7_Fig3_HTML.jpg)
...
现在你是一名 NPM 专家，你将能够添加创建一个工作节点 web 应用程序所需的任何依赖项，这是本章的主题。
...
![A323824_2_En_7_Fig4_HTML.jpg](A323824_2_En_7_Fig4_HTML.jpg)
...
![A323824_2_En_7_Fig5_HTML.jpg](A323824_2_En_7_Fig5_HTML.jpg)
...
![A323824_2_En_7_Fig6_HTML.jpg](A323824_2_En_7_Fig6_HTML.jpg)
...
![A323824_2_En_7_Fig7_HTML.jpg](A323824_2_En_7_Fig7_HTML.jpg)
...
![A323824_2_En_7_Fig8_HTML.jpg](A323824_2_En_7_Fig8_HTML.jpg)
...
现在我们已经介绍了 Node 和 Express 的基本概念，我们将使用一个小的示例应用程序来将它们放在一起。为了跟进，你需要安装一些免费软件和一些 NPM 软件包。该应用程序将包含多条路线，收集用户输入的数据，并将信息存储在数据库中。
...
![A323824_2_En_7_Fig9_HTML.jpg](A323824_2_En_7_Fig9_HTML.jpg)
...
如果您编译并运行更新后的应用程序并访问`/book`地址，您应该会看到允许添加书籍的表单。只有在提供了标题和作者的情况下，您才能提交表单。如果您在可选的 ISBN 输入中输入任何值，它必须是有效的格式，例如 10 位数字的`0-932633-42-0`或 13 位数字的`9780932633422`。

![A323824_2_En_7_Fig10_HTML.jpg](A323824_2_En_7_Fig10_HTML.jpg)
...
使用`mongoose.connect`调用建立数据库连接。示例中的连接字符串使用端口 27017；您应该使用启动`MongoDB`服务器时显示的端口号。当你的应用程序连接到数据库时，每个连接都会被记录到`MongoDB`命令窗口。
...
![A323824_2_En_7_Fig11_HTML.jpg](A323824_2_En_7_Fig11_HTML.jpg)
...
![A323824_2_En_7_Fig12_HTML.jpg](A323824_2_En_7_Fig12_HTML.jpg)
